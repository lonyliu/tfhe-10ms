...
TFheGateBootstrappingCloudKeySet* read_new_tfheGateBootstrappingCloudKeySet(const Istream& F, const TFheGateBootstrappingParameterSet* params=0) {
    ...
    LweBootstrappingKey* bk2 = read_new_lweBootstrappingKey(F,params->in_out_params, params->tgsw_params);
    LweBootstrappingKey* bk3 = read_new_lweBootstrappingKey(F,params->in_out_params, params->tgsw_params);
    LweBootstrappingKey* bk4 = read_new_lweBootstrappingKey(F,params->in_out_params, params->tgsw_params);
    ...
    return new TFheGateBootstrappingCloudKeySet(params, bk,bk2,bk3,bk4, bkFFT,bkFFT2,bkFFT3,bkFFT4);
}
