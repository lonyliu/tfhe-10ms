...
#undef INCLUDE_TFHE_CREATEBOOTSTRAPPINGKEY
	...
	tGswKeyGen(key_bk);
	LweBootstrappingKey* bk = fake_new_LweBootstrappingKey(ks_t, ks_basebit, in_params, bk_params);
	LweBootstrappingKey* bk2 = fake_new_LweBootstrappingKey(ks_t, ks_basebit, in_params, bk_params);
	LweBootstrappingKey* bk3 = fake_new_LweBootstrappingKey(ks_t, ks_basebit, in_params, bk_params);
	LweBootstrappingKey* bk4 = fake_new_LweBootstrappingKey(ks_t, ks_basebit, in_params, bk_params);

	//call the function
	tfhe_createLweBootstrappingKey(bk,bk2,bk3,bk4, key, key_bk);
